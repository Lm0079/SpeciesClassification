...
images_to_classify =  r'/user/work/gh18931/zebra_test_set'

# Classification results will be written here
classification_output_file =  r'/user/work/gh18931/giraffe_identification/species_classification_output.csv'
